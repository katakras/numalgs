...
// Allows the evaluation of expressions of the kind (f1 - f2)(x)
class SubtractFunctions : public Function {
 public:
  SubtractFunctions(std::shared_ptr<const Function> lhs,
                    std::shared_ptr<const Function> rhs);
...
// Allows the evaluation of expressions of the kind (f1 * f2)(x)
class MultiplyFunctions : public Function {
 public:
  MultiplyFunctions(std::shared_ptr<const Function> lhs,
                    std::shared_ptr<const Function> rhs);
...
// Allows the evaluation of expressions of the kind (f1 / f2)(x)
class DivideFunctions : public Function {
 public:
  DivideFunctions(std::shared_ptr<const Function> lhs,
                  std::shared_ptr<const Function> rhs);
...
// Returns a function that subtracts two different functions.
std::shared_ptr<const Function> subtract_functions(
    const std::shared_ptr<const Function>& lhs,
    const std::shared_ptr<const Function>& rhs);

// Returns a function that multiplies two different functions together.
std::shared_ptr<const Function> multiply_functions(
    const std::shared_ptr<const Function>& lhs,
    const std::shared_ptr<const Function>& rhs);

// Returns a function that divides two different functions.
